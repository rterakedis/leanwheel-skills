...
| [guide/symlinking.md](guide/symlinking.md) | Symlinks or the plugin? When to symlink the repo for live editing instead of installing the snapshot (with diagram) |
