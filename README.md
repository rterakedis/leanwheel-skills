...
| `/docs-sync` | Keep the human stand-up / operate / database guides (`docs/setup/`, `docs/maintainer/`, `docs/sql/`) and `docs/architecture.md` current as code changes — called automatically by the dev/review/retro flow, runs on Haiku |
