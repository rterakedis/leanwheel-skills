...
- [ ] Testability kept current (`docs/setup/swift/testability.md` projects): seed scenarios updated for any added/changed model entity; accessibility identifiers on new user-facing views — or N/A
