...
- [ ] Testability kept current (`docs/setup/swift/testability.md` projects): seed scenarios updated for any added/changed model entity; every accessibility identifier the Design Contract names is present **with that exact name**; any new screen has its deep-link route — or N/A
